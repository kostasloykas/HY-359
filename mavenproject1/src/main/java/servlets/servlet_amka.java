 ...
 * @author loukas
 */
public class servlet_amka extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (user_table.databaseUserToJSONamka(amka) == null && doctor_table.databaseToJSONamka(amka) == null) {
                response.setStatus(200);
            } else {
                response.setStatus(403); // yparxei auto to amka sthn database
            }
